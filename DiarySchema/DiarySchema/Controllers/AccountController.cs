...
namespace DiarySchema.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var result = Redirect("/Account/Login");
            if(ControllerContext.HttpContext.User.IsInRole("Student"))
                result  = Redirect("/Student/Index");
            else if (ControllerContext.HttpContext.User.IsInRole("Lucturer"))
                result = Redirect("/Lucturer/Index");
            else if (ControllerContext.HttpContext.User.IsInRole("Admin"))
